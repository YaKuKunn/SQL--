error id: file:///X:/SQL学习/demo/src/main/java/com/example/JDBC_study.java:java/lang/String#repeat().
file:///X:/SQL学习/demo/src/main/java/com/example/JDBC_study.java
empty definition using pc, found symbol in pc: java/lang/String#repeat().
