error id: file:///X:/SQL学习/demo/src/main/java/com/example/JDBC_study.java:org/springframework/web/bind/annotation/RestController#
...
public class JDBC_study {
    ...
    public static void main(String[] args) {
        ...
        // 1. 基本查询示例
        System.out.println("【示例 1】基本查询 - 查询所有用户:");
        queryAllUsers();
