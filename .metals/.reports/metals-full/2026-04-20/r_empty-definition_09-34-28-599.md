error id: file:///X:/SQL学习/JDBC_study.java:java/sql/Connection#setAutoCommit().
file:///X:/SQL学习/JDBC_study.java
empty definition using pc, found symbol in pc: java/sql/Connection#setAutoCommit().
empty definition using semanticdb
empty definition using fallback
non-local guesses:

offset: 8379
uri: file:///X:/SQL学习/JDBC_study.java
text:
```scala
import java.sql.*;
...
public class JDBC_study {
    ...
    public static void queryUserByUsername(String username) {
        String sql = "SELECT id, username, email, create_time FROM users WHERE username = ?";
